  ...
  return (
    <div className="bg-background text-textDark min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <div className="max-w-3xl mx-auto space-y-10 py-16 px-4 w-full">
          <section>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-primary leading-tight">Kernwaarden</h1>
            <p>Advies Over Cijfers denkt met u mee over welke financiële dienstverlening het beste past bij uw onderneming. Het doel van AOC is om de financiële situatie van uw onderneming op begrijpelijke wijze aan u over te brengen. Het leveren van een goede kwaliteit en persoonlijk contact zijn kernwaarden van AOC.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <p>Persoonlijk contact met maar één contactpersoon, wel zo prettig. Uw financiën op een begrijpelijke manier rapporteren is dé reden waarom AOC is opgericht. Graag vertellen wij u in een persoonlijk gesprek (telefonisch, videoverbinding of op locatie) over de mogelijkheden voor uw bedrijf.</p>
          </section>
        </div>
      </main>
    </div>
